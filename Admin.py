...
def insertAdmin():
    while True :
        ...
        mydb.commit()
        print()
        ch=input("Do you want to add more Administrators?[Yes/No] : ")
...
def deleteAdmin():
    while True:
        ...
        mydb.commit()
        ch=input("Do you want to delete more Administrators?[Yes/No] : ")
        if ch=="no" or ch=="No" or ch=="NO":
            break
    return
#---------------------------------------------------------------------------------------------------------     
def searchAdmin():
    while True:
        ...
        ch=input("Do you want to Search more Administrators?[Yes/No] : ")
        if ch=="no" or ch=="No" or ch=="NO":
            break
    return
#--------------------------------------------------------------------------------------------------------- 
